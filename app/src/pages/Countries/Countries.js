...
import AddEditCountryModal from './AddEditModal';
  ...
  */
    ...
    const openEditModal = (country) => {
        if (!userDetails.email) {
            M.toast({
                html: 'Please log in before adding countries.',
                displayLength: 2000,
    ...
    const openModal = () => {
        if (!userDetails.email) {
            M.toast({
                html: 'Please enter your name above before adding countries.',
                displayLength: 2000,
                classes: 'red lighten-2',
            });
            return;
                ...
                {loaded ? (
                    <>
                        <AddEditCountryModal
                            ...
                            editCountryData={currentEditCountry}
                        ...
                        <div className="container center">
                            ...
                            <div style={{ marginBottom: '20px' }}>
                                <em className="tb-grey-text">
                                    <span className="text-bold tb-teal-text">{displayData?.length?.toLocaleString()}</span> countries
                                </em>
                            </div>
                                        ...
                                        displayData.map((item, index) => (
                                            <React.Fragment key={item.id}>
                                                <tr>
                                                    ...
                                                    <td style={{ verticalAlign: 'top' }}>
                                                        <p>{item.core_destination_name}</p>
                                                    </td>
